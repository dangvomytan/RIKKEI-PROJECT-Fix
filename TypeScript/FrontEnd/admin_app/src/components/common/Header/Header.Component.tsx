              ...
              <li className="relative flex items-center pr-2">
                ...
                >
                      ...
                      <div className="flex py-1">
                        <div className="my-auto">
                          <img
                            ...
                            className="inline-flex items-center justify-center mr-4 text-sm text-black h-9 w-9 max-w-none rounded-xl"
                          />
                        </div>
                        <div className="flex flex-col justify-center">
                          <h6 className="mb-1 text-sm font-normal leading-normal dark:text-black">
                            <span className="font-semibold">New message</span>{" "}
                            from Laur
                          </h6>
                          <p className="mb-0 text-xs leading-tight text-slate-400 dark:text-black/80">
                      ...
                      <div className="flex py-1">
                        <div className="my-auto">
                          <img
                            ...
                            className="inline-flex items-center justify-center mr-4 text-sm text-black bg-gradient-to-tl from-zinc-800 to-zinc-700 dark:bg-gradient-to-tl dark:from-slate-750 dark:to-gray-850 h-9 w-9 max-w-none rounded-xl"
                          />
                        </div>
                        <div className="flex flex-col justify-center">
                          <h6 className="mb-1 text-sm font-normal leading-normal dark:text-black">
                  ...
                  {/* <li className="relative">
                    ...
                    >
                      <div className="flex py-1">
                        <div className="inline-flex items-center justify-center my-auto mr-4 text-sm text-black transition-all duration-200 ease-nav-brand bg-gradient-to-tl from-slate-600 to-slate-300 h-9 w-9 rounded-xl">
                          <svg
                            width="12px"
                            height="12px"
                            viewBox="0 0 43 36"
